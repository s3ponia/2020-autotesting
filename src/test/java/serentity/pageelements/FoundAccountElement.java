package serentity.pageelements;
...
public class FoundAccountElement {
    ...
    public String name() {
        return this.webElementFacade.find(By.className("sm__79ad9")).getText().split(" ")[0];
    }

    public String surname() {
        return this.webElementFacade.find(By.className("sm__79ad9")).getText().split(" ")[1];
    }
}
